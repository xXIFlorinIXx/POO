...
public:
	...
	{
		cout << "Nume magazin: ";
		getline(cin, this->nume_magazin);
		cout << "Adresa magazin: ";
		getline(cin, this->adresa_magazin);
		cout << "Numar de contact: ";
		getline(cin, this->numar_de_contact_magazin);
		cout << "Adresa de email: ";
		getline(cin, this->adresa_email);
		cout << endl;
	}
	void denumire()
	{
	...
	{
		cout << "Numarul de contact al magazinului " << this->nume_magazin << " este " << this->numar_de_contact_magazin << " si email-ul este " << this->adresa_email << endl;
		cout << endl;
	}
	...
	bool Verificare_date()
	{
		...
		while (!s.Verificare_email() && s.adresa_email != "x" && s.adresa_email != "X")
		{
			cout << "Introduceti o adresa de email valida!" << endl
				 << "Daca nu introduceti o adresa de email valida magazinul nu poate fi creat!!" << endl
				 << "Pentru a opri citirea unei adrese de email valide introduceti x/X!!!" << endl;
			cout << "Adresa email: ";
			getline(cin, s.adresa_email);
		}
		...
		{
			cout << "Introduceti un numar de contact valid!" << endl
				 << "Daca nu introduceti un numar de contact valid magazinul nu poate fi creat!!" << endl
				 << "Pentru a opri citirea unui numar de contact valid introduceti x/X!!!" << endl;
			cout << "Numar de contact: ";
			getline(cin, s.numar_de_contact_magazin);
		}
...
{ // clasa produse este derivata din magazin
public:
	string nume_produs;
	float pret;
	int cantitate;
	...
	{
		cout << "Nume produs: ";
		getline(cin, this->nume_produs);
		cout << "Pretul produs: ";
		cin >> this->pret;
		cout << "Cantitatea de produse: ";
		cin >> this->cantitate;
		cin.get();
		cout << "Data expirari acestui lot(zz:ll:aaaa): ";
		getline(cin, this->data_expiriare);
		while (Corectitudine_Data(this->data_expiriare) == 0)
		{
			getline(cin, this->data_expiriare);
		}
		cout << "Data primire lot(zz::ll:aaaa): ";
	...
	void Informatii_produs()
	{
		if (shop != NULL)
		{
			...
			cout << "Produsul " << this->nume_produs << " nu face parte dintr-un magazin!" << endl
				 << endl;
	}
